...
const LoginSchema = z.object({
  username: z.string().min(4, USERNAME_VALIDATION_MESSAGE).max(31, USERNAME_VALIDATION_MESSAGE),
  password: z.string().min(6, PASSWORD_VALIDATION_MESSAGE).max(255, PASSWORD_VALIDATION_MESSAGE),
});
